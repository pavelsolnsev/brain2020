...
$lander       = "https://example.com/demo/lander-stub";
$title        = '';
$land         = 'brain_2020';
$unit         = 'sbs';
$type         = 'brain_2020';
...
// $partner_array = json_decode(file_get_contents("https://example.com/demo/global__FR-partners.json"), true);
...
$action_franchise = implode(array(
    'https://example.com/demo/lander-stub',
    '&unit=', $unit,
    '&type=', $type,
    '&land=', $land,
    '&version=', $version,
