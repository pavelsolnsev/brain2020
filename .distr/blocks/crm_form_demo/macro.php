...
<div class="form {{form_class}} form__container">
	<form action="#" method="post" class="form__content nolander {{ form_box }}" onsubmit="return false;">
		...
		<input type="hidden" name="redirect_url" value="https://example.com/online-price/">
		<?php else : ?>
		<input type="hidden" name="redirect_url" value="https://example.com/ochnoe/">
		<?php endif; ?>
		<input type="hidden" name="token" value="">
		<input type="hidden" name="responsible_id" value="">
