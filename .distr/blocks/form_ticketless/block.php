...
<div class="form {{form_class}} form__container">
   <form class="form__content {{ form_box }}" action="<?=$action_ticketless?>&unit=payments&type=ticketless&quote_id={{quote_id}}&form={{form_form}}&callbackSuccess=https://example.com/demo/payment-success&new_tab=1">
