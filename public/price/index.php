  ...
  <div class="container">
    ...
    <div class="price__online">
      ...
      <div class="price__online-middle">
        ...
        <div class="price__online-middle-txt">Запись на портале <a href="https://example.com/" target="_blank" style="text-decoration: underline;">онлайн-платформа</a> в течении 2-х недель</div>
      ...
      <div class="price__item">
        <div class="price__item-title title-section">
          ...
          <ul class="price__item-list">
            ...
            <li class="price__item-list-item">Сопровождение искусственным интеллектом на протяжении всего форума</li>
            <!-- <li class="price__item-list-item">Пакет участника</li> -->
            <li class="price__item-list-item">Доступ к платформе <a href="https://example.com/" target="_blank" style="text-decoration: underline;">онлайн-платформа</a>  на 1 месяц</li>
      ...
      <div class="price__item">
        <div class="price__item-title title-section">
          ...
          <ul class="price__item-list">
            ...
            <li class="price__item-list-item">Доступ к платформе <a href="https://example.com/" target="_blank" style="text-decoration: underline;">онлайн-платформа</a>  на 6 месяцев</li>
            <!-- <li class="price__item-list-item">Подарки от партнеров и спонсоров</li> -->
          </ul>
