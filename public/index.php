	...
	<div class="container header__container">
		...
		<div class="header__content">
			...
			<a href="" class="header__logo-link">
				...
				<?php /* ?><a href="https://example.com"><img class="header__logo" src="https://example.com/vtb/img/vtb_logo_white.svg" alt=""></a><?php */ ?>
  ...
  <?php endif; ?>
    ...
    <div class="speakers__list-item speakers__list-item5">
      ...
      <div class="speakers__list-item-text">
        ...
        <p class="speakers__list-item-info">Демо-спикер</p>
      </div>
  ...
  <div class="container">
    <div class="fullprice__online">
      ...
      <div class="fullprice__online-middle">
        ...
        <div class="fullprice__online-middle-txt">Запись на портале <a href="https://example.com/" target="_blank" style="text-decoration: underline;">онлайн-платформа</a> в течении 2-х недель</div>
        
      </div>
      <div class="fullprice__online-cost">
        <div class="fullprice__online-cost-val"><?=number_format($online_price, 0, ',', ' ')?>&nbsp;₽</div>
        <a href="https://example.com/demo/price" class="fullprice__online-cost-btn button">Купить</a>
      ...
      <div class="fullprice__item">
        <div class="fullprice__item-title title-section">
          ...
          <ul class="fullprice__item-list">
            ...
            <li class="fullprice__item-list-item">Сопровождение искусственным интеллектом на протяжении всего форума</li>
            <!-- <li class="fullprice__item-list-item">Пакет участника</li> -->
            <li class="fullprice__item-list-item">Доступ к платформе <a href="https://example.com/" target="_blank" style="text-decoration: underline;">онлайн-платформа</a>  на 1 месяц</li>
      ...
      <div class="fullprice__item">
        <div class="fullprice__item-title title-section">
          ...
          <ul class="gullprice__item-list">
            ...
            <li class="gullprice__item-list-item">Доступ к платформе <a href="https://example.com/" target="_blank" style="text-decoration: underline;">онлайн-платформа</a>  на 6 месяцев</li>
	...
	<div class="container">
		...
		<div class="gallery__block">
			...
			<div class="gallery__block-video">
				...
				<a class="gallery__block-link" href="https://example.com/demo/gallery" target="_blank" rel="noopener noreferrer">
					<span>#brain2022</span>
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td data-label="Тема">Марафон Brain Game (демо)</td>
						<td data-label="Формат">Keynote speech</td>
		...
		<div class="partners__partnersSlider owl-carousel">
				...
				if ( $is_partners_card ) { ?>
					<div class="partners__partnersSlider-item">
						<div class="partners__partnersSlider-inner">
						<?php if ( $lang != 'en' ) { ?>
							<a href="https://trendfox.ru/?utm_source=demo&amp;utm_term=demo" target="_blank">
						<?php }  ?>
				...
				if ( $is_partners_card ) { ?>
					<div class="partners__partnersSlider-item">
						<div class="partners__partnersSlider-inner">
						<?php if ( $lang != 'en' ) { ?>
							<a href="https://example.com/demo/partner" target="_blank">
						<?php }  ?>
				...
				if ( $is_partners_card ) { ?>
					<div class="partners__partnersSlider-item">
						<div class="partners__partnersSlider-inner">
						<?php if ( $lang != 'en' ) { ?>
							<a href="https://gessmarket.ru/?utm_source=demo&amp;utm_medium=demo&amp;utm_campaign=demo" target="_blank">
						<?php }  ?>
	...
	<div class="container">
		<div class="franchise__main">
			<div class="franchise__main-item">
				<h2 class="franchise__title title-section">Франшиза (демо)</h2>
			</div>
		...
		<div class="franchise__description">
			<div class="franchise__description-item">
				...
				<p class="franchise__description-text">Организатор (демо)&nbsp;&mdash; масштабных бизнес-мероприятий в&nbsp;России и&nbsp;за&nbsp;рубежом. Среди наших достижений&nbsp;&mdash; две записи в&nbsp;Книге рекордов Гиннесса и&nbsp;престижные event-награды. Крупный форум (демо) собрал на&nbsp;стадионе &laquo;Газпром Арена&raquo; 125 топовых спикеров и&nbsp;более 25&nbsp;000&nbsp;участников.</p>
			...
			<div class="franchise__description-item  franchise__description-title_last">
				...
				<p class="franchise__description-text">Франшиза Школы бизнеса позволит стать эксклюзивным представителем &laquo;организатора&raquo; в&nbsp;вашем регионе. Вы&nbsp;получите готовую продуктовую линейку, базу клиентов, технологии маркетинга и&nbsp;продаж и&nbsp;поддержку головного офиса.</p>
	...
	<div class="container footer__container">
		...
		<div class="footer__content">
			...
			<div class="footer__right">
				<a class="footer__copyright-link fancybox-privacy-link" href="https://example.com/lp/_chunk/privacy.php?date=15-01-2019&amp;lang=<?=$lang?>" data-fancybox=""><?= _t('footer__copyright-link') ?></a>

				<div class="footer__item"><?= _t('footer__sydi') ?>
					<a class="footer__syndigital" href="https://example.com" target="_blank">Портфолио</a>
				</div>
...
<div class="form vertical form__container">
   <form class="form__content " action="<?=$action_ticketless?>&unit=payments&type=ticketless&quote_id=4140&form=price-ticket&callbackSuccess=https://example.com/demo/payment-success&new_tab=1">
...
<div class="form vertical form__container">
   <form class="form__content " action="<?=$action_ticketless?>&unit=payments&type=ticketless&quote_id=4246&form=price-ticket&callbackSuccess=https://example.com/demo/payment-success&new_tab=1">
...
<div class="form vertical form__container">
   <form class="form__content " action="<?=$action_ticketless?>&unit=payments&type=ticket&quote_id=4460&form=price-ticket&callbackSuccess=https://example.com/demo/payment-success&new_tab=1">
...
<div class="popup popup-accreditation" id="popup-accreditation">
	...
	<div class="popup-accreditation__body popup-accreditation__inner">
		<div class="popup-accreditation__text">Пресс-служба (демо)&nbsp;— <a href="mailto:press@example.com" target="_blank">press@example.com</a></div>
	<div class="popup-accreditation__text">Решение о&nbsp;предоставление аккредитации будет направлено Вам на&nbsp;почту.</div>
	<div class="popup-accreditation__rules"><a class="popup-accreditation__rules-link" href="https://example.com/files/media_draft_citation_rules_ru.pdf" target="_blank" data-fancybox="">Правила цитирования для&nbsp;СМИ</a></div>
	</div>
</div>
	...
	<script>
		function thanks_page() {
			setTimeout(function(){
			location.replace('https://example.com/demo/price/?date=autodate&partner=<?=$partner?>');
			}, 100);
		}
	</script>
	<?php } else { ?>
	<script>
		function thanks_page() {
			setTimeout(function(){
			location.replace('https://example.com/demo/price');
			}, 100);
		}
	</script>
	<?php } ?>
